...
import "../moviedetailpage/moviedetailcss.css"; // Import your CSS file
...
export default function MovieDetailPage() {
  ...
  }, [id,apiKey]); // Fetch movie details whenever `id` changes
    ...
    <div className="movie-detail-container">
      <div className="detail-container">
        ...
        <div className="flex flex-col mt-[30px] second-grid">
          <div>
            <h1 className="text-5xl tracking-wider">{movie.title}</h1>
          </div>
          <div>
          ...
          <div className="mt-10">
            <p className="text-2xl font-bold tracking-widest">Discription: &nbsp;</p>
          ...
          <div className="mt-10">
            <p> <span className="text-red-500 text-3xl">budget: &nbsp;</span> {movie.budget}</p>
          </div>
          <button style={{
            marginTop:"80px",
            marginBottom:"30px"
