...
export default function TvSerial() {
  ...
  function tvonclickhandle(id) {
    navigatingtv(`/tv-serial-detail/${id}`); //to view in detail for specific tvserial
  }
  ...
  // Memoized function to fetch TV data - for performance 
  ...
  return (
    <div className="movie-container">
      ...
      {/* this is paggination show previous and next button to view next page */}
